	...
	<div id="bodys-bg" class="bodys-bg">
          <div id="bodys-1" >
			...
			<ul class="bodys-nav">
				...
				<li id="hov" class="hov"><a href="#"><h2  id="hov" class="hov"><img src="./images/new.png">&nbsp&nbsp&nbsp楼栋管理</h2></a></li>
		...
		<div id="bodys-right-list" class="bodys-right-list">
			<ul>
				<li><h1  align="center" style="color:#4a68ab;font-size:22px;">楼栋管理</h1></li>
			</ul>
			<table border="1px" id="maintable">
			<tr>
				<th width="18%">楼栋号</th>
				<th width="25%">楼栋名</th>
				<th width="18%">楼栋管理员</th>
				<th width="35%">操作</th>
			</tr>
			<%  
            	while (rs.next()) {  
          ...
          <tr>
            ...
            <td style="text-align:center;">  
             ...
             <td style="text-align:center;">
          <a href="storeyupdate.jsp?tno=<%= rs.getString(1)%>&&tname=<%= rs.getString(2)%>&&tmanager=<%= rs.getString(3)%>" >修改</a>
          <a href="storeyupdate.jsp?action=delete&&tno=<%= rs.getString(1)%>&&tname=<%= rs.getString(2)%>&&tmanager=<%= rs.getString(3)%>" >删除</a>
          </td>  
        </tr>  
        <%  
            }  
        %>  
                   			...
                   			<a href="storeyinsert.jsp"><input type="button" value="添加" style="width:100px;height:35px;padding:5px;border-radius:5px;"></a>
