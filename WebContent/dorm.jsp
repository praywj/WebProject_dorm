	...
	<div id="bodys-bg" class="bodys-bg">
          <div id="bodys-1" >
			...
			<ul class="bodys-nav">
				...
				<li id="hov" class="hov"><a href="dorm.jsp"><h2  id="hov" class="hov"><img src="./images/new.png">&nbsp&nbsp&nbsp宿舍管理</h2></a></li>
		...
		<div id="bodys-right-list" class="bodys-right-list">
			<ul>
				<li><h1  align="center" style="color:#4a68ab;font-size:22px;">宿舍管理</h1></li>
				</ul>
			<table border="1px" id="maintable">
			<tr>
				<th width="20%">宿舍号</th>
				<th width="20%">楼栋号</th>
				<th width="20%">寝室长学号</th>
          ...
          <tr>
            ...
            <td style="text-align:center;">  
             ...
             <td style="text-align:center;">
          <a href="dormupdate.jsp?dno=<%= rs.getString(1)%>&&tno=<%= rs.getString(2)%>&&sno=<%= rs.getString(3)%>" >修改</a>
          <a href="dormupdate.jsp?action=delete&&dno=<%= rs.getString(1)%>&&<%= rs.getString(2)%>&&sno=<%= rs.getString(3)%>" >删除</a>
          </td>  
        </tr>  
        <%  
            }  
        %>  
                    			...
                    			<a href="dorminsert.jsp"><input type="button" value="添加" style="width:100px;height:35px;padding:5px;border-radius:5px;"></a>
          </div>          
	</div>
</div>
</div>
